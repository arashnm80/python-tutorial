...
- برنامه ای بنویسید که از کاربر کلمات درست و اشتباه را بپرسد و کلمه ی درست را با کلمه ی اشتباه، جابجا کند
...
- برنامه ای بنویسید که تعدادی از قفسه های کتاب همراه کتابها داشته باشد، با دیکشنری انجام دهید، سپس برای کاربر امکان تغییر، یا اضافه کردن به کتابهای قفسه را فراهم کنید
```
قفسه ی 2 .... نام کتاب ... نشان دادن تمام لیست کتابها .... پرسیدن از کاربر که آیا میخواد تغییر بده یا نه.... اگر بله ... باید شماره قفسه ی کتاب گرفته بشه ... و تغییرات در اون اعمال بشه اگر نه برنامه پیام موفقیت آمیز بودن عملیات بده
```
...
کلاسی بسازید که یک اتاق اداری رو برای ما توصیف کنه، رنگ دیوارهاش، اندازه ی اتاقمون، و چیزهای دیگه ای که خودتون به ذهنتون میرسه
