...
3. ***ما در دنیایی هستیم که هوش مصنوعی داره پیشرفت میکنه و حرف اول رو توی دنیا میزنه.*** این تأثیر حتی توی برنامه نویسی هم اتفاق افتاده، کمک گرفتن از هوش مصنوعی خوبه و میتونه خیلی چیزها رو به ما یاد بده، و مثل یک معلم خوب باشه، اما باید ازش درست استفاده کنیم و با هم فکری پیش بریم. و میدونیم که برنامه نویسی مسیر سختی و شیرینی خودش رو داره، اما صبوری ما رو هم می طلبه
...
b = "hello"
```
در نام گذاری متغیر ها حواستون باشه که پایتون به حروف بزرگ و کوچک حساسه و حتی یک اشتباه کوچک باعث ارور میشه
```python
a = "hello"
A = 3
