...
توی پایتون نسخه های جدیدتر، اگر این دستور رو به تنهایی وارد کنیم ارور sub prosess میده، باید یک نسخه ی پایدار نصب کنیم، playsound==1.2.2
```
pip install playsound==1.2.2
```
بعد وقتی دوباره دستور
```
pip install playsound
```
رو وارد کنیم میگه کتابخانه ی مورد نیاز توی مسیر .... اسم مسیر رو میگه وجود داره.
