...
### حلقه
حلقه while:
وقتی که ما میخوایم یک شرط بذاریم، که ندونیم زمانش کی تموم میشه، یا چند بار تکرارش کنیم، یا کلاً برای کوتاه کردن کد خیلی خوبه، اما باید حواسمون باشه که خیلی حلقه تا حدی که میتونیم توی برنامه هامون ننویسیم تا سرعت برناممون کم نشه، و تا حدی که میتونیم و برامون امکان داره الگوریتم دیگه ای بنویسیم، while یعنی تا زمانی که.....
```python
i = 1
while i <= 5:
    print(i)
